...
def main():
    ...
    # For now, always use batch mode
    #parser.add_option("-b", "--batch", action="store_true", dest="log", help="Use Log Scale")
    ...
    if not options.hist:   # if filename is not given
            parser.error('Histogram name not given')
    '''
